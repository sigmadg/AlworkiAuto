  ...
  <div class="pa-4">
    <div class="d-flex align-center justify-space-between mb-3">
      <h6 class="text-subtitle-1">
        All Notifications
        <v-chip color="warning" variant="flat" size="small" class="ms-2 text-white"> 01 </v-chip>
      </h6>
      <a href="#" class="text-decoration-underline text-primary text-subtitle-2">Mark as all read</a>
    </div>
    <v-select v-model="selectNotify" :items="notificationDD" color="primary" variant="outlined" density="default" hide-details />
  </div>
  <v-divider />
  <PerfectScrollbar style="height: calc(100vh - 300px); max-height: 650px">
    <v-list class="py-0" lines="three">
      <v-list-item value="1" color="secondary" class="no-spacer">
        ...
        <div class="mt-3">
          <v-chip size="small" text="Unread" color="error" variant="tonal" class="me-2" />
      ...
      <v-list-item value="2" color="secondary" class="no-spacer">
        <template #prepend>
          <v-avatar size="40" variant="flat" color="lightsuccess" class="me-3 py-2 text-success">
      ...
      <v-list-item value="3" color="secondary" class="no-spacer">
        <template #prepend>
          <v-avatar size="40" variant="flat" color="lightprimary" class="me-3 py-2 text-primary">
            <MailboxIcon size="20" />
          </v-avatar>
        </template>
        <div class="d-inline-flex align-center justify-space-between w-100">
      ...
      <v-list-item value="4" color="secondary" class="no-spacer">
        ...
        <div class="mt-3 bg-lightsecondary rounded pa-5 d-flex align-center">
          ...
          <span class="ms-2 text-subtitle-1">demo.jpg</span>
        </div>
      </v-list-item>
      <v-divider />
