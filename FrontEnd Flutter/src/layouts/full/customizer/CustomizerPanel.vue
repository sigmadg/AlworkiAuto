                  ...
                  <v-card-text class="pa-0">
                    <v-item-group v-model="customizer.actTheme" mandatory>
                      <v-item v-for="theme in themeColors" v-slot="{ isSelected, toggle }" :key="theme.name" :value="theme.name">
                        <v-avatar rounded="circle" :class="theme.bg" class="me-2 cursor-pointer ma-2" size="40" @click="toggle">
                ...
                <div class="d-flex justify-space-between align-center pa-5">
                  ...
                  <div>
                    <v-radio-group v-model="customizer.isRtl" class="custom-radio ma-n2" hide-details>
                      ...
                      <v-radio :value="rtlmode" color="primary" class="ma-2">
                ...
                <div class="d-flex justify-space-between align-center pa-5">
                  ...
                  <div>
                    <v-radio-group v-model="customizer.inputBg" class="custom-radio input-radio ma-n2" hide-details>
                      <v-radio :value="true" color="primary" class="ma-2 input-bg" />
                      <v-radio :value="false" color="primary" class="ma-2" />
                    </v-radio-group>
                  </div>
                </div>
