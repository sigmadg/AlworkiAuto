    ...
    <v-row class="taskBoardBox ma-0">
      <v-col cols="3" v-for="column in getTask" :key="column.title">
        <div class="bg-lightprimary pa-4 rounded-md">
          ...
          <v-card class="pa-3 pt-1 mt-2" v-if="showTaskform === column.id">
            <v-text-field
              variant="plain"
              hide-details
              density="compact"
            ...
            ></v-text-field>
            <div class="d-flex align-center mt-3 ga-1">
              <v-btn icon size="small" variant="text" color="primary"><v-icon icon="$accountOutline"></v-icon></v-btn>
              <v-btn icon size="small" variant="text" color="primary"><CalendarIcon size="16" /></v-btn>
              <v-btn icon size="small" class="ms-auto" variant="text" color="error"><XIcon size="16" /></v-btn>
