...
<template>
  ...
  <!-- Transitions -->
  <!-- ----------------------------------------------------------------------------- -->
  <p class="text-subtitle-1 text-grey-darken-1">You can make the dialog appear from the top or the bottom.</p>
  <div class="text-center mt-6 d-flex align-center flex-wrap ga-2 justify-center">
    ...
    <v-dialog transition="dialog-top-transition">
      <template #activator="{ props }">
        <v-btn color="secondary" class="ms-2" v-bind="props"> From the top </v-btn>
      </template>
      <template #default="{ isActive }">
        <v-card>
