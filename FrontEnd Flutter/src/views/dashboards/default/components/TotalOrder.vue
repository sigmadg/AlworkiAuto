      ...
      <v-tabs-window v-model="tab" class="z-1">
        <v-tabs-window-item value="1">
          <v-row>
            ...
            <v-col cols="6">
              <apexchart type="line" class="text-darkText" height="90" :options="chartOptions1" :series="lineChart1.series" />
            </v-col>
          </v-row>
        </v-tabs-window-item>
        <v-tabs-window-item value="2">
          <v-row>
            ...
            <v-col cols="6">
              <apexchart type="line" class="text-darkText" height="90" :options="chartOptions2" :series="lineChart2.series" />
            </v-col>
          </v-row>
        </v-tabs-window-item>
      </v-tabs-window>
