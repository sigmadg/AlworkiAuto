...
const page = ref({ title: 'Form Validation Page' });
      ...
      <UiParentCard title="On Type">
        <Form>
          ...
          <v-text-field
            ...
            class="mb-3"
          />
          <v-text-field v-model="email" :rules="[rules.required, rules.email]" label="E-mail" variant="outlined" class="mb-3" />
          <v-text-field
            v-model="password"
            color="primary"
            label="Password"
        ...
        <div class="d-inline-flex flex-column ga-4 items-center">
          <div>
            <v-form ref="myform">
              ...
              <v-btn variant="outlined" color="primary" class="mt-4" @click="submit"> Submit </v-btn>
            </v-form>
          </div>
        </div>
      </UiParentCard>
      ...
      <UiParentCard title="Radio button">
        ...
        <div>
          <v-form ref="myRadioform">
            ...
            <p v-if="selectedRadioValues.length < 1" class="text-error mb-4">You have to choose one Drink</p>
            <v-btn variant="outlined" color="primary" @click="submitRadio"> Submit </v-btn>
          </v-form>
        </div>
      </UiParentCard>
    </v-col>
