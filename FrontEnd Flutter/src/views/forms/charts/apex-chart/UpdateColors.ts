...
const getPrimary = computed(() => {
  ...
  } else if (custmizer.actTheme === 'DarkPurpleTheme') {
    return darkthemeColors.DarkPurpleTheme.colors.primary;
  } else if (custmizer.actTheme === 'DarkGreenTheme') {
    return darkthemeColors.DarkGreenTheme.colors.primary;
  } else if (custmizer.actTheme === 'DarkPinkTheme') {
    return darkthemeColors.DarkPinkTheme.colors.primary;
  } else if (custmizer.actTheme === 'DarkYellowTheme') {
    return darkthemeColors.DarkYellowTheme.colors.primary;
  } else if (custmizer.actTheme === 'DarkSeaGreenTheme') {
    return darkthemeColors.DarkSeaGreenTheme.colors.primary;
  } else if (custmizer.actTheme === 'DarkOliveGreenTheme') {
    return darkthemeColors.DarkOliveGreenTheme.colors.primary;
  } else if (custmizer.actTheme === 'DarkSpeechBlueTheme') {
    return darkthemeColors.DarkSpeechBlueTheme.colors.primary;
  } else {
...
const getSecondary = computed(() => {
  if (custmizer.actTheme === 'GreenTheme') {
    ...
    return darkthemeColors.DarkPurpleTheme.colors.secondary;
  } else if (custmizer.actTheme === 'DarkGreenTheme') {
    return darkthemeColors.DarkGreenTheme.colors.secondary;
  } else if (custmizer.actTheme === 'DarkPinkTheme') {
    return darkthemeColors.DarkPinkTheme.colors.secondary;
  } else if (custmizer.actTheme === 'DarkYellowTheme') {
    return darkthemeColors.DarkYellowTheme.colors.secondary;
  } else if (custmizer.actTheme === 'DarkSeaGreenTheme') {
    return darkthemeColors.DarkSeaGreenTheme.colors.secondary;
  } else if (custmizer.actTheme === 'DarkOliveGreenTheme') {
    return darkthemeColors.DarkOliveGreenTheme.colors.secondary;
  } else if (custmizer.actTheme === 'DarkSpeechBlueTheme') {
    return darkthemeColors.DarkSpeechBlueTheme.colors.secondary;
  } else {
