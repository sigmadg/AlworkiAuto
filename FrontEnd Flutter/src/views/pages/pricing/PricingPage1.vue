      ...
      <v-card elevation="0">
        <v-card variant="outlined" :style="plan.active ? 'border:2px solid rgb(var(--v-theme-secondary))' : ''">
          <v-card-text class="text-center">
            ...
            <v-list class="PricingList text-start">
              <v-list-item
              ...
              >
                <v-icon v-if="plan.permission.includes(index)" color="success" icon="$check"> </v-icon>
                <v-icon v-else aria-disabled="true" icon="$check"> </v-icon>
                {{ list }}
              </v-list-item>
            </v-list>
