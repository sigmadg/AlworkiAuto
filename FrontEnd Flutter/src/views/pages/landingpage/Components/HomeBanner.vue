    ...
    <v-container class="maxWidth">
      <v-row class="spacer align-center" style="height: calc(100vh - 74px)">
        <v-col cols="12" lg="5" md="5">
          <div class="pr-lg-4 text-md-start text-center">
            <h1 class="bannerText my-5" data-aos="fade-up" data-aos-duration="500">
              Build Your Next Project With <span class="text-primary">Alworki</span>
            </h1>
            <p class="mb-8" data-aos="fade-up" data-aos-duration="800">
              La forma más fácil de encontrar expertos y soluciones
            </p>
            <div data-aos="fade-up" data-aos-duration="1000">
              <v-btn color="secondary" size="large" class="me-2" to="/dashboard/default">
                <template #prepend>
                  <v-icon style="margin-bottom: -2px" icon="$play"> </v-icon>
                </template>
                Live Preview
              </v-btn>
              <v-btn
        ...
        <v-col cols="12" lg="7" md="7" class="d-none d-md-block">
          <div class="position-relative" style="z-index: 1">
            ...
            <div class="widget1">
              <img :src="widget1" alt="widget" class="widgetImages" />
            </div>
            <div class="widget2">
              <img :src="widget2" alt="widget" class="widgetImages" />
            </div>
          </div>
        </v-col>
      </v-row>
