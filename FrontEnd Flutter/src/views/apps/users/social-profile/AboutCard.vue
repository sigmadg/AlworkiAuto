    ...
    <v-col cols="12">
      <v-card variant="flat" class="pa-5">
        <div class="d-flex ga-6 mb-5 align-center pb-4 border-bottom">
          ...
          <v-btn icon variant="flat" class="ms-auto">
