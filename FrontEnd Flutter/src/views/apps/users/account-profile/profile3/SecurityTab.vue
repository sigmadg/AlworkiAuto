      ...
      <v-card variant="flat">
        <v-card variant="outlined">
          ...
          <v-card-text>
            <v-row>
              <v-col cols="12">
                <v-text-field type="text" label="Current password" color="primary" variant="outlined" hide-details />
              </v-col>
              <v-col cols="12" lg="6">
                <v-text-field type="email" label="New Password" color="primary" variant="outlined" hide-details />
              </v-col>
              <v-col cols="12" lg="6">
                <v-text-field type="text" label="Re-enter New Password" color="primary" variant="outlined" hide-details />
              </v-col>
            </v-row>
