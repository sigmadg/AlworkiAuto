  ...
  <v-row>
    <v-col cols="12">
      <UiParentCard title="Create Invoice">
        <v-row>
          <v-col cols="12" lg="4">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2"> Invoice Number<span class="ms-1">*</span> </v-label>
            <v-text-field
              v-model="textinvoice"
              type="text"
              color="primary"
        ...
        <v-row>
          <v-col cols="12" lg="4">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2"> Customer Name<span class="ms-1">*</span> </v-label>
            <v-text-field
          ...
          <v-col cols="12" lg="4">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2"> Customer Email<span class="ms-1">*</span> </v-label>
            <v-text-field
          ...
          <v-col cols="12" lg="4">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2"> Customer Contact Numer<span class="ms-1">*</span> </v-label>
            <v-text-field
          ...
          <v-col cols="12">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2"> Customer Address<span class="ms-1">*</span> </v-label>
            <v-text-field
        ...
        <v-row>
          <v-col cols="12" lg="6">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2"> Invoice Date<span class="ms-1">*</span> </v-label>
            <v-text-field
              v-model="textdate"
              type="text"
              color="primary"
          ...
          <v-col cols="12" lg="6">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2"> Status<span class="ms-1">*</span> </v-label>
            <v-select v-model="textstatus" color="primary" :items="status" variant="outlined" hide-details />
          </v-col>
        </v-row>
        <v-divider class="my-6" />
        ...
        <v-row>
          <v-col cols="12">
            <v-label class="text-subtitle-1 text-high-emphasis mb-2"> Terms and Condition:<span class="ms-1">*</span> </v-label>
            <v-text-field
              v-model="textterms"
              type="text"
              color="primary"
