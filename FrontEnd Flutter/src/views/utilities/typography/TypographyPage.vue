      ...
      <UiParentCard title="Basic Typography">
        <UiChildCard title="Heading">
          <div class="d-flex flex-column gap-1">
            <v-card v-for="[name, cls] in headings" :key="name" variant="outlined" class="my-4">
              <div :class="[cls, 'pa-2']">
                {{ name }}
              </div>
        ...
        <UiChildCard title="Text-alignment" class="mt-8">
          <div>
            <p class="text-start">Left aligned on all viewport sizes.</p>
            <p class="text-center">Center aligned on all viewport sizes.</p>
            <p class="text-end">Right aligned on all viewport sizes.</p>

            <p class="text-sm-start">Left aligned on viewports SM (small) or wider.</p>
            <p class="text-end text-md-start">Left aligned on viewports MD (medium) or wider.</p>
            <p class="text-end text-lg-start">Left aligned on viewports LG (large) or wider.</p>
            <p class="text-end text-xl-left">Left aligned on viewports XL (extra-large) or wider.</p>
          </div>
        </UiChildCard>
