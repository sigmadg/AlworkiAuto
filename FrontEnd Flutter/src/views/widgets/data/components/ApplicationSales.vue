...
<template>
  <v-table>
    <thead>
      <tr>
        <th class="text-start text-subtitle-1">Application</th>
        <th class="text-end text-subtitle-1">Sales</th>
        <th class="text-end text-subtitle-1">Avg. Price</th>
        <th class="text-end text-subtitle-1">Total</th>
      </tr>
    </thead>
    <tbody>
