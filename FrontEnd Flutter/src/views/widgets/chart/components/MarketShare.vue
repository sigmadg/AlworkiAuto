...
const chartOptions1 = computed(() => {
  return {
    ...
    colors: ['#f44336', getSecondary.value, getPrimary.value],
    dataLabels: {
      enabled: false
    },
    stroke: {
    ...
    <v-card variant="outlined">
      <v-card-text>
        <div class="d-sm-flex align-center">
          ...
          <h3 class="text-h3 mt-4 mt-sm-0 ms-auto d-flex align-center">
            <TrendingDownIcon width="34" class="text-error me-2" stroke-width="2" />27, 695.65
          </h3>
        </div>
